<template>
    <div class="c-Introduce">
        <div><img :src='nowPlayList.coverImgUrl' /></div>
        <div>
            <h3>{{ nowPlayList.name }}<svg t="1654008303376" class="icon" viewBox="0 0 1024 1024" version="1.1"
                    ...
                    <path
                        ...
                        fill="#28CA67" p-id="2420"></path>
                </svg></h3>

            <span>{{ nowPlayList.description }}</span>
        </div>
    </div>
</template>
...
export default {
    ...
    created() {
        this.nowPlayList = this.$store.state.songs.playList
